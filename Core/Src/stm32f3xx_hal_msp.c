...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA15     ------> SPI1_NSS
    */
    HAL_GPIO_DeInit(GPIOA, SPI1_SCK_Pin|SPI1_MISO_Pin|SPI1_MISOA7_Pin|GPIO_PIN_15);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, OSD_TX_Pin|OSD_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(DE_485_GPIO_Port, DE_485_Pin);
